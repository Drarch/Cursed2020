...
func setup():
	...
	name = "g_build" # String to identify the goal from others after creation
	...
	add_symbol("s_no_constraction_sites", true)
...
func evaluate():
	...
	var dic = {
		"s_no_constraction_sites": !Globals.constructionSites.empty(),
		"s_has_cargo": entity.hasCargo(),
		"s_has_target": entity.target != null
	}
