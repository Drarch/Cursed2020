...
func setup():
	...
	name = "a_drop_cargo" # String identifier of this action. setup_common() will make sure the action's node is named after this
	...
	add_effect("s_storage_full", true)
...
func get_target_location():
	...
	var target = entity.target.position
