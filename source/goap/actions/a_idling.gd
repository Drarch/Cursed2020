...
func setup():
	...
	name = "a_idling" # String identifier of this action. setup_common() will make sure the action's node is named after this
...
func execute():
	...
	if entity.position.distance_squared_to(target) < 100:
		return COMPLETED
