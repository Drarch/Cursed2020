...
func setup():
	...
	name = "a_chopWood" # String identifier of this action. setup_common() will make sure the action's node is named after this
...
func get_target_location():
	...
	return entity.get_node("../Tree").get_global_position()
