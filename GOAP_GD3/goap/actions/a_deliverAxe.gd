...
func setup():
	...
	name = "a_deliverAxe" # String identifier of this action. setup_common() will make sure the action's node is named after this
	...
	add_precondition("s_hasAxe", true)
	
	# Effects - use add_effect(string symbol, bool value)
	add_effect("s_deliveredAxe", true)
