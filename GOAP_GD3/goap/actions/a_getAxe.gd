...
func setup():
	...
	name = "a_getAxe" # String identifier of this action. setup_common() will make sure the action's node is named after this
...
func evaluate():
	...
	if (entity.hasAxe): return false
	if (entity.pile.axes < 1): return false
	return true
