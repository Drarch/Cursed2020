...
func setup():
	...
	name = "a_getPick" # String identifier of this action. setup_common() will make sure the action's node is named after this
...
func evaluate():
	...
	if (entity.hasPick): return false
	if (entity.pile.picks < 1): return false
