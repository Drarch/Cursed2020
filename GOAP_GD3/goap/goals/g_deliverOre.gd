...
func setup():
	...
	name = "g_deliverOre" # String to identify the goal from others after creation
	...
	add_symbol("s_deliveredOre", true)
	return
...
func evaluate():
	...
	# Always try to deliver ore
	return {"s_deliveredOre":false}
