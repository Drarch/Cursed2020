...
func setup():
	...
	name = "g_deliverFish" # String to identify the goal from others after creation
	...
	add_symbol("s_deliveredFish", true)
	return
...
func evaluate():
	...
	# Always want to deliver Fish
	return {"s_deliveredFish":false}
